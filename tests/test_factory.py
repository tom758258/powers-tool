...
def test_near_term_and_later_models_are_recognized() -> None:
    for model in (
        ...
        selection = select_driver(f"KEYSIGHT,{model},MY00000000,1.0")
...
def test_unknown_model_falls_back_to_generic_driver() -> None:
    selection = select_driver("KEYSIGHT,UNKNOWN,MY00000000,1.0")
...
def test_select_driver_accepts_preparsed_idn() -> None:
    parsed = parse_idn("KEYSIGHT,E36232A,MY00000000,1.0")
