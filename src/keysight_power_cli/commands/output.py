...
def register_commands(subparsers: argparse._SubParsersAction[Any], runtime: Any) -> None:
    ...
    runtime._add_model_argument(set_parser)
    ...
    runtime._add_model_argument(output_on_parser)
    ...
    runtime._add_model_argument(output_off_parser)
    ...
    runtime._add_model_argument(safe_off_parser)
    ...
    runtime._add_model_argument(output_state_parser)
    ...
    runtime._add_model_argument(cycle_output_parser)
    ...
    runtime._add_model_argument(apply_parser)
    ...
    runtime._add_model_argument(ramp_parser)
    ...
    runtime._add_model_argument(smoke_output_parser)
