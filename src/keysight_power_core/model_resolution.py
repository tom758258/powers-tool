...
from keysight_power_core.models import CANDIDATE_MODELS, PRODUCT_ACTIVE_MODELS, parse_idn

PRODUCT_MODEL_PROFILES = PRODUCT_ACTIVE_MODELS
CANDIDATE_MODEL_PROFILES = CANDIDATE_MODELS
